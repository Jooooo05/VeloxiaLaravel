    ...
    <div class="reservation-form">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <form id="reservation-form" name="gs" method="post" action="{{ route('store.reservation') }}">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-6">
                                <fieldset>
                                    ...
                                    <input type="text" id="Name" name="Name" class="Name"
                                        placeholder="ex. TJ Sinaga" autocomplete="on" required>
                                </fieldset>
                            </div>
                            <div class="col-lg-6">
                                <fieldset>
                            ...
                            <div class="col-lg-12">
                                <fieldset>
                                    <button type="submit" class="main-button">Confirm your Book</button>
                                </fieldset>
                            </div>
                        </div>
                    </form>
