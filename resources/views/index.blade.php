      ...
      <div id="top-banner-1" class="banner">
        <div class="banner-inner-wrapper header-text">
          <div class="main-caption">
            <h2 class="">Take a Glimpse Into The Beautiful Country Of :</h2>
            <h1 class="">Caribbean</h1>
                ...
                <div class="more-info">
                  <div class="row">
                    <div class="col-lg-3 col-sm-6 col-6">
                      ...
                      <h4 class=""><span>Population:</span><br>44.48 M</h4>
                    </div>
                    <div class="col-lg-3 col-sm-6 col-6">
                      <i class="fa fa-globe border-warning"></i>
                      <h4 class=""><span>Territory:</span><br>27.400 KM<em>2</em></h4>
                    </div>
                    <div class="col-lg-3 col-sm-6 col-6">
                      <i class="fa fa-home border-warning"></i>
                      <h4 class=""><span>AVG Price:</span><br>$946.000</h4>
                    </div>
                    <div class="col-lg-3 col-sm-6 col-6">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-8 col-sm-7">
                    <div class="right-content">
                      ...
                      <p>We hope this WoOx template is useful for you, please support us a We really appreciate your contribution.</p>
                      <ul class="info">
